...
@Composable fun PhotoPanel(repo:Repository,visit:Visit) {
    ...
    LaunchedEffect(visit.id,visit.sync,visit.body){try{photos=repository.list(visit)}catch(e:kotlinx.coroutines.CancellationException){throw e}catch(e:Exception){android.util.Log.e("Collettori","Elenco fotografie",e);error="Impossibile leggere le fotografie"}}
